...
TransferDialog::TransferDialog(bool isDownload, bool isDrop,
  ...
  if (mIsEditMode && mJobOptions != nullptr) {
    ...
    if (isDownload) {
      ...
      /*
            ...
            ui.label_defaultTransferOptions->setText("Default download
         options:"); ui.le_defaultTransferOptions->setText(
                settings->value("Settings/defaultDownloadOptions").toString());
  ...
  /*
  ui.le_defaultRcloneOptions->setEnabled(false);
  ui.le_defaultTransferOptions->setEnabled(false);
  */
}
